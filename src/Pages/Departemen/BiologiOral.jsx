...
export function BiologiOral() {
  ...
  return (
    <>
      {/* Judul Hero sekarang dinamis mengikuti nama departemen dari database */}
      <PageHero
      ...
      <ContentSection>
        ...
        <div className="max-w-full space-y-8">
          {/* Deskripsi profil departemen dinamis dari database (jika ada field keterangan/deskripsi) */}
          {departemen.DeptKeterangan ? (
            <div
              dangerouslySetInnerHTML={{ __html: departemen.DeptKeterangan }}
              className="max-w-[900px] text-gray-700 leading-relaxed text-base prose"
            />
          ) : (
            <p className="max-w-[900px] text-gray-700 leading-relaxed">
              Selamat datang di halaman resmi Departemen {departemen.DeptNama}.
              Halaman ini memuat informasi profil dan susunan jajaran staf dosen
              pengajar.
            </p>
          )}

          {/* Bagian Grid List Dosen */}
